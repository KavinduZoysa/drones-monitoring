...
const CREATE_RESTRICTED_AREA_INFO_TABLE = "CREATE TABLE IF NOT EXISTS drones_monitor.restricted_areas(areaId INT(10) NOT NULL AUTO_INCREMENT, name VARCHAR(255), numberOfPoints INT(10), points VARCHAR(255), PRIMARY KEY (areaId));";

const SELECT_DRONES_INFO_PER_DRONE = "INSERT INTO drones_monitor.drones_info(droneID, latitude, longitude, time) values (${droneId}, ${latitude}, ${longitude}, ${t.time.toString()})";
